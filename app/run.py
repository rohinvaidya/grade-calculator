...
my_grades.midterm = 1.0 # Received 100% in the Midterm Exam
my_grades.project = 0.85 # Received 85% in the Project
my_grades.final = 1.0 # Received 78% in the Final Exam 
